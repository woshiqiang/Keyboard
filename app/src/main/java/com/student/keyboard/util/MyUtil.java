    ...
    public static void switchUpperOrLowerCase(boolean isUpper, Keyboard keyboard) {
        ...
        if (isUpper) {
            ...
            for (Keyboard.Key key : keyList) {
                ...
                if (!TextUtils.isEmpty(label) && key.codes[0] != DemoKeyCode.CODE_TYPE_SPACE && key.codes[0] != DemoKeyCode.KEYCODE_DONE
                        && key.codes[0] != DemoKeyCode.CODE_TYPE_SEARCH
                        && key.codes[0] != DemoKeyCode.CODE_TYPE_CHANGE) {
